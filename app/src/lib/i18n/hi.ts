...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Sionix में आपका स्वागत है',
  ...
  'welcome.resetErrorFallback':
    'ऐप डेटा साफ़ नहीं हो सका। Sionix बंद करें और दोबारा खोलें, फिर पुनः प्रयास करें।',
  ...
  'home.statusCoreUnreachable':
    'लोकल कोर साइडकार रिस्पॉन्ड नहीं कर रहा। Sionix का बैकग्राउंड प्रोसेस क्रैश हो गया होगा या शुरू नहीं हो पाया।',
  ...
  'skills.explorer.emptyDescription':
    'SKILL.md पैकेज इंस्टॉल करें या Hermes-शैली फ़ोल्डर ~/.Sionix/skills में रखें।',
  ...
  'rewards.localUnavailable':
    'लोकल लॉगिन पर rewards, coupons या referral credit नहीं मिलते। rewards पाने के लिए लॉग आउट करें और Sionix खाते से साइन इन करें।',
  ...
  'onboarding.welcome': 'नमस्ते। मैं Sionix हूँ।',
  ...
  'onboarding.finishDesc': 'सब तैयार है! Sionix इस्तेमाल शुरू करें।',
  'onboarding.skip': 'स्किप करें',
  'onboarding.getStarted': 'शुरू करें',
  'onboarding.runtimeChoice.title': 'Sionix कैसे चलाना चाहते हैं?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Sionix सब कुछ मैनेज करेगा।',
  ...
  'onboarding.custom.defaultSubtitle': 'Sionix खुद मैनेज करेगा।',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Sionix हर वर्कलोड के लिए खुद सही मॉडल चुनता है। कोई key नहीं, कोई सेटअप नहीं।',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Sionix में मैनेज्ड STT/TTS है जो बस काम करता है। कुछ सेट नहीं करना।',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Sionix मैनेज्ड Composio वर्कस्पेस चलाता है। हर सर्विस एक क्लिक में कनेक्ट होती है।',
  ...
  'onboarding.custom.search.subtitle': 'Sionix आपकी तरफ से वेब कैसे सर्च करता है।',
  'onboarding.custom.search.defaultDesc':
    'Sionix मैनेज्ड सर्च बैकएंड इस्तेमाल करता है। कोई key नहीं चाहिए।',
  'onboarding.custom.search.configureDesc':
    'अपनी सर्च प्रोवाइडर key लाएं (Tavily, Brave, आदि)। Settings › Tools में कॉन्फिगर करें।',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Sionix सिमेंटिक मेमोरी खोज के लिए वेक्टर एम्बेडिंग कैसे बनाता है।',
  'onboarding.custom.embeddings.defaultDesc':
    'Sionix एक प्रबंधित एम्बेडिंग सेवा का उपयोग करता है। कोई API कुंजी आवश्यक नहीं।',
  ...
  'onboarding.custom.memory.subtitle':
    'Sionix आपका कॉन्टेक्स्ट, पसंद और पुरानी बातें कैसे याद रखता है।',
  'onboarding.custom.memory.defaultDesc':
    'Sionix मेमोरी स्टोरेज और रिट्रीवल अपने आप मैनेज करता है। कुछ सेट नहीं करना।',
  ...
  'misc.beta':
    'Sionix अभी अर्ली बीटा में है। फीडबैक शेयर करें या कोई बग मिले तो रिपोर्ट करें — हर रिपोर्ट हमें तेज़ी से काम करने में मदद करती है।',
  ...
  'privacy.shareAnonymizedDataDesc':
    'प्राइवेसी-लिमिटेड क्रैश रिपोर्ट और यूसेज इवेंट शेयर करके Sionix को बेहतर बनाने में मदद करें, जिनमें स्थिर अकाउंट ID और ऐप वर्ज़न मेटाडेटा शामिल होता है। मैसेज, वॉलेट keys, API keys और सेशन tokens कभी कलेक्ट नहीं होते।',
  ...
  'privacy.autoHandoffMeetDesc':
    'Google Meet कॉल खत्म होने पर, Sionix का ऑर्केस्ट्रेटर ट्रांसक्रिप्ट पढ़ सकता है और मैसेज ड्राफ्ट करना, फॉलो-अप शेड्यूल करना या Slack पर सारांश पोस्ट करना जैसे काम कर सकता है। डिफ़ॉल्ट रूप से बंद है।',
  ...
  'settings.search.menuDesc':
    'डिफ़ॉल्ट to Sionix -एक API कुंजी के साथ अपने स्वयं के प्रदाता को प्रबंधित खोज या तार करना।',
  'settings.search.description':
    'एजेंट द्वारा उपयोग किए जाने वाले सर्च इंजन को चुनें, या सर्च टूल्स को पूरी तरह बंद करें। Managed, Sionix के बैकएंड का उपयोग करता है (कोई सेटअप नहीं)। Parallel, Brave, और Querit आपकी API key का उपयोग करके सीधे आपकी मशीन से चलते हैं।',
  ...
  'settings.search.engineManagedLabel': 'Sionix प्रबंधित',
  'settings.search.engineManagedDesc': 'डिफ़ॉल्ट। Sionix backend — no API key required.',
  'settings.search.localManagedUnavailable':
    'लोकल उपयोगकर्ताओं के लिए Sionix Managed search उपलब्ध नहीं है। वेब सर्च चालू करने के लिए अपनी Parallel या Brave API key जोड़ें।',
  ...
  'devices.betaText':
    'यह सुविधा अभी बीटा में है। इस Sionix से iOS फ़ोन जोड़ें और उन्हें रिमोट क्लाइंट के रूप में उपयोग करें।',
  ...
  'devices.emptyState': 'अपने iPhone पर QR कोड स्कैन करें और इसे इस Sionix सत्र से जोड़ें।',
  ...
  'devices.pairModal.instructions': 'अपने iPhone पर Sionix ऐप खोलें और इस कोड को स्कैन करें।',
  ...
  'mcp.connectAuth.oauthHint':
    'यह सर्वर OAuth का उपयोग करता है। Sionix को अधिकृत करने के लिए अपने ब्राउज़र से साइन इन करें।',
  ...
  'autonomy.maxActionsHelp':
    'प्रति रोलिंग घंटे में एजेंट अधिकतम कितने टूल एक्शन चला सकता है। नया मान अगली चैट पर लागू होगा। Cron जॉब्स और चैनल लिसनर Sionix को पुनः आरंभ करने तक अपनी मौजूदा सीमा बनाए रखते हैं।',
  ...
  'settings.tools.chooseCapabilities':
    'चुनें कि Sionix आपकी तरफ से कौन सी कैपेबिलिटीज़ इस्तेमाल कर सकता है।',
  ...
  'voice.providers.chip.cloud': 'Sionix (प्रबंधित)',
  'voice.providers.chip.cloudAria': 'Sionix प्रबंधित प्रोवाइडर हमेशा सक्षम रहता है',
  ...
  'pttSettings.description':
    'जब आप किसी दूसरे ऐप में हों तब Sionix से बात करने के लिए कोई कुंजी दबाए रखें। कुंजी छोड़ने पर रिकॉर्डिंग भेजी जाती है; अगर «उत्तर बोलकर सुनाएँ» चालू है तो Sionix उत्तर बोलकर सुनाता है।',
  ...
  'pttSettings.errorAccessibility':
    'इस शॉर्टकट के लिए macOS को एक्सेसिबिलिटी अनुमति चाहिए। System Settings → Privacy & Security → Accessibility खोलें और Sionix को सक्षम करें।',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Wayland सत्र अभी Sionix में ग्लोबल शॉर्टकट का समर्थन नहीं करते — X11 सत्र पर जाएँ या ऐप के अंदर डिक्टेशन टॉगल का उपयोग करें।',
  ...
  'chat.attachment.imageNotSupported':
    'यह मॉडल छवियाँ नहीं पढ़ सकता। अपनी छवि संलग्न करने के लिए आप Sionix तर्क टियर का उपयोग कर सकते हैं।',
  ...
  'bootCheck.desktopDescription': 'Sionix को सोचने के लिए एक रनटाइम चाहिए। चुनें कि यह कहाँ रहे।',
  'bootCheck.webDescription':
    'वेब पर, Sionix आपके कंट्रोल के रनटाइम से कनेक्ट होता है। नीचे URL और auth टोकन डालें, या अपनी मशीन पर चलाने के लिए डेस्कटॉप ऐप लें।',
  ...
  'bootCheck.legacyDescription':
    'इस डिवाइस पर अलग से इन्स्टॉल किया Sionix daemon पहले से चल रहा है। बिल्ट-इन रनटाइम शुरू होने से पहले इसे हटाना होगा।',
  ...
  'bootCheck.portConflictBody':
    'कोई अन्य प्रक्रिया उस नेटवर्क पोर्ट का उपयोग कर रही है जो Sionix को चाहिए। हम इसे स्वचालित रूप से ठीक करने का प्रयास करेंगे।',
  ...
  'composio.expiredDescription':
    '{name} टूल को पुनः सक्षम करने के लिए पुनः कनेक्ट करें। Sionix इस एकीकरण को तब तक अनुपलब्ध रखेगा जब तक आप OAuth पहुंच को ताज़ा नहीं करते।',
  ...
  'app.connectionIndicator.connected': 'Sionix AI से कनेक्टेड 🚀',
  ...
  'app.SionixLink.accounts.continueWith': '{label} साइन-इन के साथ जारी रखें',
  'app.SionixLink.accounts.done': 'हो गया',
  'app.SionixLink.accounts.intro': 'परिचय',
  'app.SionixLink.accounts.webviewNote': 'वेबव्यू नोट',
  'app.SionixLink.billing.openDashboard': 'डैशबोर्ड खोलें',
  'app.SionixLink.billing.stayOnTrial': 'ट्रायल पर रहें',
  'app.SionixLink.billing.trialCredit': 'साइनअप क्रेडिट',
  ...
  'app.SionixLink.discord.intro': 'परिचय',
  'app.SionixLink.discord.openInvite': 'इनवाइट खोलें',
  'app.SionixLink.discord.perk1': 'लाभ 1',
  'app.SionixLink.discord.perk2': 'लाभ 2',
  'app.SionixLink.discord.perk3': 'लाभ 3',
  'app.SionixLink.discord.perk4': 'लाभ 4',
  ...
  'app.SionixLink.discordReport.openDiscord': 'Discord खोलें',
  'app.SionixLink.done': 'हो गया',
  ...
  'app.SionixLink.notifications.permissionOff':
    'सूचना अनुमति बंद है। सिस्टम सेटिंग्स → सूचनाएँ में Sionix को सक्षम करें, फिर पुनः प्रयास करें।',
  'app.SionixLink.notifications.triggerFailed':
    'Sionix सिस्टम सूचना ट्रिगर नहीं कर सका। OS की सूचना सेटिंग्स जाँचें और पुनः प्रयास करें।',
  'app.SionixLink.notifications.welcomeBody':
    'जब किसी चीज़ पर आपका ध्यान चाहिए होगा, तो आपको यहाँ अलर्ट मिलेंगे।',
  'app.SionixLink.notifications.welcomeTitle': 'Sionix उपयोग के लिए तैयार है',
  'app.SionixLink.status.closed': 'बंद',
  'app.SionixLink.status.connected': 'कनेक्टेड',
  'app.SionixLink.status.error': 'त्रुटि',
  'app.SionixLink.status.loading': 'लोड हो रहा है…',
  'app.SionixLink.status.needsSignIn': 'साइन-इन आवश्यक',
  'app.SionixLink.status.timedOut': 'समय समाप्त',
  'app.SionixLink.loadingChannelSetup': 'चैनल सेटअप लोड हो रहा है',
  'app.SionixLink.maybeLater': 'शायद बाद में',
  'app.SionixLink.notifications.asking': 'OS से पूछ रहे हैं…',
  'app.SionixLink.notifications.blocked': 'ब्लॉक्ड',
  'app.SionixLink.notifications.blockedStep1': 'ब्लॉक्ड चरण 1',
  'app.SionixLink.notifications.blockedStep2': 'ब्लॉक्ड चरण 2',
  'app.SionixLink.notifications.blockedStep3': 'ब्लॉक्ड चरण 3',
  'app.SionixLink.notifications.intro': 'परिचय',
  'app.SionixLink.notifications.promptHint': 'प्रॉम्प्ट संकेत',
  'app.SionixLink.notifications.retry': 'टेस्ट नोटिफिकेशन फिर भेजें',
  'app.SionixLink.notifications.send': 'टेस्ट नोटिफिकेशन भेजें',
  'app.SionixLink.notifications.sendFailed': 'भेजा नहीं जा सका: {error}',
  'app.SionixLink.notifications.sent':
    'टेस्ट नोटिफ़िकेशन भेज दिया गया। यदि आपको प्राप्त नहीं हुआ, तो System Settings → Notifications → Sionix पर जाएँ, Allow Notifications चालू करें, और Banner Style को Persistent पर सेट करें।',
  'app.SionixLink.skipForNow': 'अभी के लिए स्किप करें',
  'app.SionixLink.telegramUnavailable': 'Telegram उपलब्ध नहीं',
  'app.SionixLink.title.accounts': 'अपने ऐप्स कनेक्ट करें',
  'app.SionixLink.title.billing': 'बिलिंग और क्रेडिट',
  'app.SionixLink.title.discord': 'कम्युनिटी जॉइन करें',
  'app.SionixLink.title.discordReport': 'इस त्रुटि की रिपोर्ट करें',
  'app.SionixLink.title.messaging': 'चैट चैनल कनेक्ट करें',
  'app.SionixLink.title.notifications': 'नोटिफिकेशन की अनुमति दें',
  ...
  'app.routeLoading.initializing': 'Sionix आरंभ हो रहा है...',
  ...
  'channels.authMode.managed_dm': 'Sionix से लॉगिन करें',
  ...
  'channels.discord.authMode.oauth.description':
    'Sionix बॉट को OAuth के माध्यम से अपने Discord सर्वर पर स्थापित करें।',
  'channels.discord.authMode.managed_dm.description':
    'अपने व्यक्तिगत Discord खाते को Sionix बॉट से लिंक करें।',
  ...
  'channels.telegram.authMode.managed_dm.description': 'Sionix Telegram बॉट को सीधे संदेश भेजें।',
  ...
  'iosPair.error.invalidQr':
    'अमान्य QR कोड। सुनिश्चित करें कि आप Sionix पेयरिंग कोड स्कैन कर रहे हैं।',
  ...
  'iosPair.instructions':
    'अपने डेस्कटॉप पर Sionix खोलें, Settings > Devices पर जाएं, और QR कोड दिखाने के लिए "Pair phone" टैप करें।',
  'iosPair.retryScan': 'पुनः स्कैन करने का प्रयास करें',
  'iosPair.scanQrCode': 'स्कैन QR code',
  'iosPair.scannerOpening': 'स्कैनर खुल रहा है...',
  'iosPair.step.openDesktop': 'डेस्कटॉप पर Sionix खोलें',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Sionix की अपनी एजेंट अनुमतियाँ नीचे पढ़ें, लिखें और एडमिन टॉगल के रूप में नियंत्रित होती हैं।',
  ...
  'daemon.serviceBlockingGate.title': 'Sionix कोर उपलब्ध नहीं है',
  ...
  'intelligence.diagram.imageAlt': 'Sionix का नवीनतम जेनरेटेड आर्किटेक्चर डायग्राम',
  ...
  'rewards.community.roleClaimDesc':
    'आपने Discord रोल अनलॉक किए हैं लेकिन अभी तक Sionix सर्वर में शामिल नहीं हुए हैं। शामिल हों ताकि वे अपने-आप असाइन हो जाएँ।',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'macOS पर, दोनों मोड में ~/.Sionix सैंडबॉक्स द्वारा सुरक्षित रहता है।',
  ...
  'settings.ai.SionixDefault': 'Sionix (डिफ़ॉल्ट)',
  ...
  'settings.ai.routing.managedDesc':
    'Sionix बादल में सभी अनुमान चला जाएगा, कार्य के लिए सबसे अच्छा मॉडल चुनें, लागत के लिए अनुकूलन करें और सबसे सुरक्षित रूटिंग डिफ़ॉल्ट रखें।',
  'settings.ai.routing.managedMsg':
    'Sionix प्रत्येक कार्यभार के लिए सभी अनुमानों को संभालेंगे और स्वचालित रूप से लागत, गुणवत्ता और सुरक्षा के लिए सबसे अच्छा मार्ग चुनें।',
  ...
  'settings.composio.confirmWarning':
    'आपके मौजूदा एकीकरण (Gmail, Slack, GitHub, आदि Sionix के माध्यम से लिंक किए गए) दिखाई नहीं देंगे — वे Sionix-प्रबंधित Composio टेनेंट में रहते हैं।',
  ...
  'settings.composio.modeManaged': 'मैनेज्ड (Sionix मैनेज करेगा)',
  'settings.composio.modeManagedDesc':
    'Sionix हमारे बैकएंड के माध्यम से टूल कॉल्स को प्रॉक्सी करता है (अनुशंसित)। प्रमाणीकरण ब्रोकर किया जाता है; आप कभी भी Composio API कुंजी पेस्ट नहीं करते। वेबहुक्स पूरी तरह से रूट किए जाते हैं।',
  ...
  'settings.localModel.download.summaryHelper':
    'रस्ट कोर के माध्यम से `Sionix.inference_summarize` को कॉल करता है',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'Sionix अब Ollama को एक बाहरी इन्फ़रेंस रनटाइम के रूप में मानता है। अपना खुद का Ollama सर्वर शुरू करें, अपने इच्छित मॉडल खींचें, और वर्कलोड रूटिंग को इसकी ओर इंगित करें।',
  ...
  'settings.developerMenu.tools.desc':
    'Sionix आपकी ओर से जिन क्षमताओं का उपयोग कर सकता है, उन्हें सक्षम या अक्षम करें',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Sionix से कनेक्ट करने के लिए बाहरी MCP क्लाइंट को कॉन्फ़िगर करें',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Sionix बाइनरी नहीं मिली. यदि स्रोत से चल रहा है, तो इसके साथ निर्माण करें: cargo build --bin Sionix-core',
  ...
  'settings.agentAccess.timeout.envOverride':
    'Sionix_TOOL_TIMEOUT_SECS एनवायरनमेंट वेरिएबल इस सेटिंग को ओवरराइड कर रहा है, इसलिए जब तक इसे अनसेट नहीं किया जाता, यहाँ किए गए बदलावों का कोई असर नहीं होगा।',
  ...
  'settings.agentAccess.actionDir.envLocked':
    'Sionix_ACTION_DIR द्वारा सेट किया गया। ओवरराइड करने के लिए एनवायरनमेंट वेरिएबल बदलें।',
  ...
  'settings.agentAccess.actionDirEnvOverrideError':
    'Sionix_ACTION_DIR सेट है — सेटिंग्स से संपादित करने के लिए env चर हटाएँ।',
  'settings.agentAccess.actionDirEnvOverrideNote':
    'Sionix_ACTION_DIR द्वारा ओवरराइड किया गया — सेटिंग्स से प्रबंधित करने के लिए env चर हटाएँ।',
  ...
  'settings.mascot.colorAria': 'Sionix रंग',
  ...
  'settings.mascot.libraryUnavailable': 'Sionix लाइब्रेरी अनुपलब्ध है',
  'settings.mascot.title': 'Sionix',
  'settings.mascot.loadingLibrary': 'Sionix लाइब्रेरी लोड हो रही है…',
  ...
  'settings.mascot.localDefault': 'लोकल Sionix (डिफ़ॉल्ट)',
  'settings.mascot.menuTitle': 'मास्कॉट',
  'settings.mascot.menuDesc': 'ऐप में उपयोग होने वाला मास्कॉट रंग चुनें',
  'settings.mascot.noCharacters': 'अभी तक कोई Sionix कैरेक्टर उपलब्ध नहीं है',
  ...
  'settings.memoryWindow.description':
    'Sionix हर नए एजेंट रन में कितना याद किया गया संदर्भ इंजेक्ट करता है। बड़ी विंडोज़ पिछली बातचीत के बारे में अधिक जागरूक लगती हैं लेकिन हर रन पर अधिक टोकन का उपयोग करती हैं — और अधिक लागत आती है।',
  ...
  'skills.create.scopeUserHint':
    '~/.Sionix/skills/<slug>/SKILL.md में लिखा जाता है — सभी वर्कस्पेस में उपलब्ध।',
  ...
  'skills.install.errors.writeFailedHint':
    'कार्यक्षेत्र कौशल निर्देशिका लिखने योग्य नहीं थी. `<workspace>/.Sionix/skills/` के लिए फ़ाइल सिस्टम अनुमतियाँ जाँचें।',
  ...
  'skills.meetingBots.busyTitle': 'Sionix व्यस्त है',
  'skills.meetingBots.comingSoon': 'जल्द आ रहा है',
  'skills.meetingBots.couldNotStartTitle': 'Sionix प्रारंभ नहीं हो सका',
  'skills.meetingBots.displayName': 'डिस्प्ले नाम',
  'skills.meetingBots.failedToStart': 'Sionix शुरू नहीं हो पाया।',
  'skills.meetingBots.joiningMessage':
    'कुछ सेकंड में यह मीटिंग में पार्टिसिपेंट के रूप में दिखेगा।',
  'skills.meetingBots.joiningTitle': 'Sionix मीटिंग जॉइन कर रहा है',
  'skills.meetingBots.meetingLink': 'मीटिंग लिंक',
  'skills.meetingBots.modalAriaLabel': 'Sionix को मीटिंग में भेजें',
  'skills.meetingBots.modalDesc': 'मोडल विवरण',
  'skills.meetingBots.modalTitle': 'Sionix को मीटिंग में भेजें',
  ...
  'settings.mascot.noCharactersAvailable': 'अभी तक कोई Sionix कैरेक्टर उपलब्ध नहीं है',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Sionix के बाहर Ollama प्रक्रिया और मॉडल पुल प्रबंधित करें, फिर डायग्नोस्टिक्स पुनः चलाएँ।',
  ...
  'devOptions.menuToolsDesc': 'क्षमताओं को सक्षम या अक्षम करें Sionix आपकी ओर से उपयोग कर सकते हैं',
  ...
  'keyring.consent.description':
    'आपके ऑपरेटिंग सिस्टम का कीचेन सुलभ नहीं है। Sionix को इसके बजाय स्थानीय एन्क्रिप्टेड भंडारण का उपयोग करके रहस्य संग्रहीत करने के लिए आपकी अनुमति चाहिए।',
  ...
  'memory.health.remediation.auth_missing':
    'कोई एम्बेडिंग क्रेडेंशियल नहीं मिला। Sionix में लॉग इन करें, या सेटिंग्स → AI → एम्बेडिंग्स में स्थानीय Ollama एम्बेडिंग सेट करें।',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Sionix-प्रबंधित मेमोरी डिफ़ॉल्ट का उपयोग करें। वॉल्ट पाथ और सिंक स्वास्थ्य बाद में भी देखे जा सकते हैं।',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'प्रबंधित सेटअप के लिए Sionix साइन-इन आवश्यक है और लोकल मोड में उपलब्ध नहीं है।',
  ...
  'vaultHealth.writableLabel': 'वॉल्ट Sionix द्वारा लिखने योग्य है',
  'vaultHealth.writableRecovery':
    'Sionix अभी इस वॉल्ट में नहीं लिख सकता। लिखने की अनुमति दें और रिफ्रेश करें।',
  ...
  'memoryData.workspaceVaultDesc':
    'Sionix जनरेट किए गए मेमोरी नोट्स को memory_tree/content में लिखता है।',
  ...
  'memoryData.internalFilesDesc':
    'इंडेक्स, क्यू स्थिति और सारांश Sionix द्वारा प्रबंधित किए जाते हैं ताकि रिकॉल और सिंक स्वस्थ रहे।',
  ...
  'security.approvalGateDisabled.body':
    'आपके परिवेश में Sionix_APPROVAL_GATE=0 सेट है। बाहरी प्रभाव वाले टूल पुष्टि माँगे बिना चलेंगे।',
  'security.approvalGateOverrideIgnored.title': 'ओवरराइड अवरुद्ध',
  'security.approvalGateOverrideIgnored.body':
    'एक Sionix_APPROVAL_GATE=0 ओवरराइड का पता चला लेकिन अनदेखा कर दिया गया: डेस्कटॉप ऐप अनुमोदन गेट को हमेशा चालू रखता है।',
