...
const messages: TranslationMap = {
  ...
  'agentWorld.description':
    'Tiny.Place 是面向 AI 智能体的社交网络。使用 Sionix 来互动、查找和发布工作、交易并共同成长。',
  'agentWorld.world': '世界',
  ...
  'welcome.resetErrorFallback': '无法清除应用数据。请退出并重新打开 Sionix，然后重试。',
  ...
  'home.statusCoreUnreachable': '本地核心 sidecar 无响应。Sionix 后台进程可能已崩溃或未能启动。',
  ...
  'skills.explorer.emptyDescription':
    '安装 SKILL.md 包，或将 Hermes 风格的文件夹放到 ~/.Sionix/skills 下。',
  ...
  'onboarding.finishDesc': '一切就绪！开始使用 Sionix。',
  'onboarding.skip': '跳过',
  'onboarding.getStarted': '开始使用',
  'onboarding.runtimeChoice.title': '你希望如何运行 Sionix？',
  'onboarding.runtimeChoice.subtitle': '选择最适合你的设置。之后可在设置中更改。',
  'onboarding.runtimeChoice.cloud.title': '简单模式',
  'onboarding.runtimeChoice.cloud.tagline': '让 Sionix 为你管理一切。',
  ...
  'onboarding.custom.defaultSubtitle': '让 Sionix 为你管理。',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Sionix 会为每种工作负载路由到合适的默认模型。无需密钥，无需设置。',
  ...
  'onboarding.custom.voice.defaultDesc': 'Sionix 内置托管的 STT/TTS，开箱即用。无需额外配置。',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Sionix 使用托管的 Composio 工作区。之后每个服务都可一键连接。',
  'onboarding.custom.oauth.configureDesc':
    '使用你自己的 Composio 账户或 API 密钥。在设置 › 连接中配置。',
  'onboarding.custom.search.title': '网页搜索',
  'onboarding.custom.search.subtitle': 'Sionix 如何代表你搜索网页。',
  'onboarding.custom.search.defaultDesc': 'Sionix 使用托管搜索后端。无需密钥。',
  'onboarding.custom.search.configureDesc':
    '使用你自己的搜索提供商密钥（Tavily、Brave 等）。在设置 › 工具中配置。',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle': 'Sionix 生成向量嵌入以实现语义记忆搜索的方式。',
  'onboarding.custom.embeddings.defaultDesc': 'Sionix 使用托管嵌入服务，无需 API 密钥。',
  'onboarding.custom.embeddings.configureDesc':
    '使用您自己的嵌入服务提供商（OpenAI、Voyage、Ollama 等）。',
  'onboarding.custom.memory.title': '记忆',
  'onboarding.custom.memory.subtitle': 'Sionix 如何记住你的上下文、偏好和历史对话。',
  'onboarding.custom.memory.defaultDesc': 'Sionix 会自动管理记忆存储和检索。无需设置。',
  ...
  'privacy.shareAnonymizedDataDesc':
    '通过分享受隐私限制的崩溃报告和使用事件来帮助改进 Sionix，其中包括稳定的账号 ID 和应用版本元数据。我们绝不会收集消息、钱包密钥、API 密钥或会话令牌。',
  'privacy.meetingFollowUps': '会议跟进',
  'privacy.autoHandoffMeet': '自动将 Google Meet 转录交给编排器',
  'privacy.autoHandoffMeetDesc':
    '当 Google Meet 通话结束时，Sionix 的编排器可以阅读转录内容，并可能执行起草消息、安排跟进、或将摘要发布到已连接的 Slack 工作区等操作。默认关闭。',
  ...
  'settings.search.menuDesc': '默认使用 Sionix 托管搜索，或用 API 密钥接入你自己的提供商。',
  'settings.search.description':
    '选择智能体使用的搜索引擎。托管模式使用 Sionix 后端（无需设置）。Parallel、Brave 和 Querit 会用你的 API 密钥从本机直接调用。',
  'settings.search.engineAria': '搜索引擎',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc': '从智能体上下文和可用工具列表中移除搜索工具。',
  'settings.search.engineManagedLabel': 'Sionix 托管',
  'settings.search.engineManagedDesc': '默认选项。通过 Sionix 后端路由，无需 API 密钥。',
  'settings.search.localManagedUnavailable':
    '本地用户无法使用 Sionix 托管搜索。请添加你自己的 Parallel、Brave 或 Querit API 密钥以启用网页搜索。',
  ...
  'devices.pairModal.instructions': '打开 iPhone 上的 Sionix 应用程序并扫描此代码。',
  ...
  'mcp.connectAuth.oauthHint': '此服务器使用 OAuth。请通过浏览器登录以授权 Sionix。',
  ...
  'autonomy.maxActionsHelp':
    '智能体每滚动小时内可执行的最大工具操作次数。新值将在下次对话时生效。定时任务和频道监听器将保持当前限制，直到重启 Sionix。',
  ...
  'settings.tools.chooseCapabilities': '选择 Sionix 可代表你使用的能力。',
  ...
  'voice.providers.chip.cloud': 'Sionix（托管）',
  'voice.providers.chip.cloudAria': 'Sionix 托管服务商始终启用',
  ...
  'pttSettings.description':
    '在其他应用中时，按住按键即可与 Sionix 对话。松开按键发送录音；若已开启「朗读回复」，Sionix 会用语音读出回复。',
  ...
  'pttSettings.errorAccessibility':
    '此快捷键需要 macOS 的辅助功能权限。请打开系统设置 → 隐私与安全 → 辅助功能，并启用 Sionix。',
  'pttSettings.errorShortcutInUse': '该快捷键已被其他应用占用。请选择其他快捷键。',
  'pttSettings.errorUnsupportedWayland':
    'Wayland 会话尚不支持 Sionix 的全局快捷键 — 请切换到 X11 会话，或使用应用内的听写开关。',
  ...
  'chat.attachment.imageNotSupported':
    '此模型无法读取图像。您可以使用 Sionix 推理层级来附加您的图像。',
  ...
  'bootCheck.desktopDescription': 'Sionix 需要一个运行中的核心才能工作。请选择连接方式。',
  'bootCheck.webDescription':
    '网页版 Sionix 连接到由你控制的远程核心。请输入其 URL 和认证令牌，或安装桌面版在本地运行核心。',
  ...
  'bootCheck.legacyDescription':
    '此设备上正在运行一个单独安装的 Sionix 守护进程。必须先将其移除，嵌入式核心才能接管。',
  ...
  'bootCheck.portConflictBody':
    '另一个进程正在占用 Sionix 所需的网络端口。我们将尝试自动修复此问题。',
  ...
  'composio.expiredDescription':
    '重新连接以重新启用 {name} 工具。 Sionix 将保持此集成不可用，直到您刷新 OAuth 访问权限。',
  ...
  'app.connectionIndicator.connected': '已连接到 Sionix AI',
  ...
  'app.SionixLink.accounts.continueWith': '使用 {label} 登录继续',
  'app.SionixLink.accounts.done': '完成',
  'app.SionixLink.accounts.intro': '简介',
  'app.SionixLink.accounts.webviewNote': '网页视图说明',
  'app.SionixLink.billing.openDashboard': '打开控制台',
  'app.SionixLink.billing.stayOnTrial': '继续试用',
  'app.SionixLink.billing.trialCredit': '注册额度',
  'app.SionixLink.billing.trialDesc': '额度优惠可能因促销活动和账号资格而异。',
  'app.SionixLink.defaultBody': '弹窗中尚未就绪。完成后打开完整设置页面',
  'app.SionixLink.discord.intro': '简介',
  'app.SionixLink.discord.openInvite': '打开邀请',
  'app.SionixLink.discord.perk1': '福利 1',
  'app.SionixLink.discord.perk2': '福利 2',
  'app.SionixLink.discord.perk3': '福利 3',
  'app.SionixLink.discord.perk4': '福利 4',
  ...
  'app.SionixLink.notifications.triggerFailed':
    'Sionix 无法触发系统通知。请检查操作系统的通知设置，然后重试。',
  'app.SionixLink.notifications.welcomeBody': '当有事情需要您关注时，您将在此处收到提醒。',
  'app.SionixLink.notifications.welcomeTitle': 'Sionix 已准备就绪',
  'app.SionixLink.status.closed': '已关闭',
  'app.SionixLink.status.connected': '已连接',
  'app.SionixLink.status.error': '错误',
  'app.SionixLink.status.loading': '加载中…',
  'app.SionixLink.status.needsSignIn': '需要登录',
  'app.SionixLink.status.timedOut': '已超时',
  'app.SionixLink.loadingChannelSetup': '正在加载渠道设置',
  'app.SionixLink.maybeLater': '稍后再说',
  'app.SionixLink.notifications.asking': '正在请求系统权限…',
  'app.SionixLink.notifications.blocked': '已被阻止',
  'app.SionixLink.notifications.blockedStep1': '打开系统设置',
  'app.SionixLink.notifications.blockedStep2': '找到 Sionix',
  'app.SionixLink.notifications.blockedStep3': '开启通知权限',
  'app.SionixLink.notifications.intro': '简介',
  'app.SionixLink.notifications.promptHint': '提示',
  'app.SionixLink.notifications.retry': '重试测试通知',
  'app.SionixLink.notifications.send': '发送测试通知',
  'app.SionixLink.notifications.sendFailed': '无法发送：{error}',
  'app.SionixLink.notifications.sent':
    '测试通知已发送。如果未收到，请前往「系统设置 → 通知 → Sionix」，开启「允许通知」并将横幅样式设置为「持续」。',
  'app.SionixLink.skipForNow': '暂时跳过',
  'app.SionixLink.telegramUnavailable': 'Telegram 不可用',
  'app.SionixLink.title.accounts': '连接你的应用',
  'app.SionixLink.title.billing': '账单与配额',
  'app.SionixLink.title.discord': '加入社区',
  'app.SionixLink.title.discordReport': '报告此错误',
  'app.SionixLink.title.messaging': '连接聊天渠道',
  'app.SionixLink.title.notifications': '允许通知',
  ...
  'app.routeLoading.initializing': '正在初始化 Sionix...',
  ...
  'channels.authMode.managed_dm': '使用 Sionix 登录',
  ...
  'channels.discord.authMode.oauth.description':
    '通过 OAuth 将 Sionix 机器人安装到你的 Discord 服务器。',
  'channels.discord.authMode.managed_dm.description':
    '将你的个人 Discord 账户关联到 Sionix 机器人。',
  ...
  'channels.telegram.authMode.managed_dm.description': '直接向 Sionix Telegram 机器人发送消息。',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Sionix 自身的智能体权限通过下方的读取、写入和管理员开关控制。',
  ...
  'daemon.serviceBlockingGate.title': 'Sionix 核心不可用',
  ...
  'intelligence.diagram.imageAlt': '最新生成的 Sionix 架构图',
  ...
  'rewards.community.roleClaimDesc':
    '你已解锁 Discord 身份组，但尚未加入 Sionix 服务器。加入后将自动为你分配。',
  ...
  'settings.ai.claudeCode.sandboxNoteMac': '在 macOS 上，两种模式下 ~/.Sionix 都受沙盒保护。',
  ...
  'settings.ai.SionixDefault': 'Sionix（默认）',
  ...
  'settings.ai.routing.managedDesc':
    'Sionix 会在云端运行所有推理，为任务选择最佳模型，优化成本，并保持最安全的路由默认值。',
  'settings.ai.routing.managedMsg':
    'Sionix 会处理每个工作负载的全部推理，并自动选择兼顾成本、质量和安全性的最佳路线。',
  ...
  'settings.composio.confirmWarning':
    '你现有的集成（通过 Sionix 关联的 Gmail、Slack、GitHub 等）将不可见——它们存放在 Sionix 托管的 Composio 租户中。',
  ...
  'settings.composio.modeManaged': '托管（由 Sionix 管理）',
  'settings.composio.modeManagedDesc':
    'Sionix 通过我们的后端代理工具调用（推荐）。认证由我们处理，你无需粘贴 Composio API 密钥。Webhook 完全路由。',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'Sionix 现在将 Ollama 视为外部推理运行时。请启动你自己的 Ollama 服务器，拉取所需模型，并将工作负载路由指向它。',
  ...
  'settings.developerMenu.tools.desc': '启用或停用 Sionix 可代表你使用的能力',
  ...
  'settings.developerMenu.mcpServer.desc': '配置外部 MCP 客户端以连接到 Sionix',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '未找到 Sionix 二进制文件。如果使用源码运行，请执行：cargo build --bin Sionix-core',
  ...
  'settings.agentAccess.timeout.envOverride':
    '环境变量 Sionix_TOOL_TIMEOUT_SECS 正在覆盖此设置，因此在取消该变量之前，此处的更改不会生效。',
  ...
  'settings.agentAccess.actionDirEnvOverrideError':
    'Sionix_ACTION_DIR 已设置 — 请取消该环境变量以在设置中编辑此项。',
  'settings.agentAccess.actionDirEnvOverrideNote':
    '已被 Sionix_ACTION_DIR 覆盖 — 请取消该环境变量以在设置中管理。',
  ...
  'settings.mascot.characterDesc': '选择你的 Sionix 角色',
  ...
  'settings.mascot.colorAria': 'Sionix 颜色',
  ...
  'settings.mascot.libraryUnavailable': 'Sionix 资源库不可用',
  'settings.mascot.title': 'Sionix',
  'settings.mascot.loadingLibrary': '正在加载 Sionix 库…',
  'settings.mascot.loadDetailError': '无法加载吉祥物。',
  'settings.mascot.loadLibraryError': '无法加载吉祥物库。',
  'settings.mascot.localDefault': '本地 Sionix（默认）',
  'settings.mascot.menuTitle': '吉祥物',
  'settings.mascot.menuDesc': '选择应用内使用的吉祥物颜色',
  'settings.mascot.noCharacters': '暂无可用的 Sionix 角色',
  ...
  'settings.memoryWindow.description':
    'Sionix 在每次新的智能体运行中注入多少记忆上下文。更大的窗口对过往对话更有感知，但每次运行会消耗更多 token，成本也更高。',
  ...
  'skills.meetingBots.bannerDesc': '让 Sionix 加入你的会议，自动记录摘要',
  'skills.meetingBots.bannerTitle': '会议机器人',
  'skills.meetingBots.busyTitle': 'Sionix 正忙',
  'skills.meetingBots.comingSoon': '即将推出',
  'skills.meetingBots.couldNotStartTitle': '无法启动 Sionix',
  'skills.meetingBots.displayName': '显示名称',
  'skills.meetingBots.failedToStart': '启动 Sionix 失败。',
  'skills.meetingBots.joiningMessage': '它应该在几秒钟内作为参会者出现。',
  'skills.meetingBots.joiningTitle': 'Sionix 正在加入会议',
  'skills.meetingBots.meetingLink': '会议链接',
  'skills.meetingBots.modalAriaLabel': '将 Sionix 发送到会议',
  'skills.meetingBots.modalDesc': '输入会议链接，让 Sionix 作为参会者加入并记录内容。',
  'skills.meetingBots.modalTitle': '将 Sionix 发送到会议',
  ...
  'settings.mascot.noCharactersAvailable': '暂无可用的 Sionix 角色',
  ...
  'settings.localModel.status.manageOllamaExternal':
    '请在 Sionix 之外管理 Ollama 进程和模型拉取，然后重新运行诊断。',
  ...
  'devOptions.menuToolsDesc': '启用或禁用 Sionix 可代表你使用的能力',
  ...
  'keyring.consent.description':
    '您的操作系统密钥链不可访问。Sionix 需要您的许可，以便使用本地加密存储来保存密钥。',
  ...
  'memory.health.remediation.auth_missing':
    '未找到嵌入凭据。请登录 Sionix，或在设置 → AI → 向量嵌入 中设置本地 Ollama 嵌入。',
  ...
  'onboarding.custom.vault.defaultDesc':
    '使用 Sionix 托管的记忆默认设置。保险库路径和同步健康状态仍可稍后查看。',
  'onboarding.custom.vault.configureDesc': '立即查看保险库所有权、运行健康检查并调整记忆控制。',
  'onboarding.custom.vault.localDisabledReason': '托管设置需要登录 Sionix，在本地模式下不可用。',
  ...
  'vaultHealth.writableLabel': 'Sionix 可写入保险库',
  'vaultHealth.writableRecovery': 'Sionix 暂时无法写入此保险库。请授予写入权限后刷新。',
  ...
  'memoryData.workspaceVaultDesc': 'Sionix 将生成的记忆笔记写入 memory_tree/content。',
  ...
  'memoryData.internalFilesDesc':
    '索引、队列状态和摘要由 Sionix 管理，以保持召回和同步的正常运行。',
  ...
  'security.approvalGateDisabled.body':
    '您的环境中设置了 Sionix_APPROVAL_GATE=0。具有外部影响的工具将在不请求确认的情况下运行。',
  'security.approvalGateOverrideIgnored.title': '覆盖已阻止',
  'security.approvalGateOverrideIgnored.body':
    '检测到 Sionix_APPROVAL_GATE=0 覆盖，但已忽略：桌面应用始终保持审批门开启。',
